...
class ClockTest < Minitest::Test
  ...
  def test_wrap_around_at_midnight
    ...
    clock = Clock.at(23, 30) + 121
    assert_equal '01:31', clock.to_s
  end
  ...
  def test_subtract_minutes
    ...
    clock = Clock.at(10, 10) - 90
    assert_equal '08:40', clock.to_s

    clock = Clock.at(10, 30) - 10
    assert_equal '10:20', clock.to_s
